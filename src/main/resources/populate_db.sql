...
INSERT INTO users(id, email, name, password, provider) VALUES (1, 'admin1111@gmail.com', 'admin1', '$2a$10$f86laqoRNqtI/w.jsPsnY.SAOr2nEag3yYlZZnCfvRG96WXA/8nOC', 'local');
INSERT INTO users(id, email, name, password, provider) VALUES (2, 'test1@gmail.com', 'test1', '$2a$10$s0L8MuauGVRaHHuiwBXQCeChoUKigI1CVf3WzfGU7yUh8fdVIGMi.', 'local');
--INSERT INTO users(id, email, name, password, provider) VALUES (3, 'test2@gmail.com', 'test2', '$2a$10$s0L8MuauGVRaHHuiwBXQCeChoUKigI1CVf3WzfGU7yUh8fdVIGMi.', 'local');
--INSERT INTO users(id, email, name, password, provider) VALUES (4, 'test3@gmail.com', 'test3', '$2a$10$s0L8MuauGVRaHHuiwBXQCeChoUKigI1CVf3WzfGU7yUh8fdVIGMi.', 'local');
--INSERT INTO users(id, email, name, password, provider) VALUES (5, 'test4@gmail.com', 'test4', '$2a$10$s0L8MuauGVRaHHuiwBXQCeChoUKigI1CVf3WzfGU7yUh8fdVIGMi.', 'local');
...
INSERT INTO page_types(id, type_name) VALUES (1, 'text');
INSERT INTO page_types(id, type_name) VALUES (2, 'image');
INSERT INTO page_types(id, type_name) VALUES (3, 'code');

-- INSERT INTO pages(id, num, name, content, lesson_id, page_type_id) VALUES (1, 1, 'First Page', 'it`s the first page of the first C lesson', 1, 3);
-- INSERT INTO pages(id, num, name, content, lesson_id, page_type_id) VALUES (2, 2, 'Second Page', 'it`s the Second page of the first C lesson', 1, 3);
-- INSERT INTO pages(id, num, name, content, lesson_id, page_type_id) VALUES (3, 3, 'Third Page', 'it`s the Third page of the first C lesson', 1, 1);
-- INSERT INTO pages(id, num, name, content, lesson_id, page_type_id) VALUES (4, 4, 'Fourth Page', 'it`s the fourth page of the first C lesson', 1, 1);
-- INSERT INTO pages(id, num, name, content, lesson_id, page_type_id) VALUES (5, 5, 'Fifth Page', 'it`s the fifth page of the first C lesson', 1, 1);
--
